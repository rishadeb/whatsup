...
export default function SisterLocations({
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-950 antialiased">
      ...
      <section className="mx-auto grid max-w-7xl gap-5 px-5 py-6 lg:grid-cols-[400px_minmax(0,1fr)] lg:items-start">
        <aside className="space-y-4">
          <div className="rounded-lg border border-slate-200 bg-white shadow-sm">
            <div className="flex items-center justify-between gap-3 border-b border-slate-200 px-3 py-3">
              <div>
                <h2 className="text-sm font-semibold">Comparison locations</h2>
                <p className="mt-0.5 text-[11px] text-slate-500">
                  Saved when the comparison is updated.
                </p>
              </div>
              <button
                type="button"
                className="inline-flex items-center justify-center gap-1.5 rounded-md border border-slate-300 px-2.5 py-1.5 text-xs font-semibold text-slate-700 transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400"
            ...
            <div className="divide-y divide-slate-100">
              {locations.map((location) => (
                <div key={location.id} className="space-y-2 px-3 py-2.5">
                  <div className="flex gap-2">
                    ...
                    <button
                      type="button"
                      className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md text-slate-400 transition hover:bg-rose-50 hover:text-rose-700 disabled:cursor-not-allowed disabled:opacity-40"
                  ...
                  <div className="grid grid-cols-[1fr_1fr_84px] gap-2">
                    <label className="text-[10px] font-semibold uppercase tracking-wide text-slate-500">
                      ...
                      <input
                        ...
                        className="mt-1 w-full rounded-md border border-slate-300 px-2 py-1.5 text-xs font-normal text-slate-900"
                        type="number"
                        min="-90"
                        max="90"
                        step="0.0001"
          ...
          <div className="rounded-lg border border-slate-200 bg-white px-4 py-3 shadow-sm">
            <div className="mb-3 flex items-center justify-between gap-3">
              ...
              <span className="text-[11px] text-slate-500">
                Weather does not affect the plot
              </span>
            </div>
